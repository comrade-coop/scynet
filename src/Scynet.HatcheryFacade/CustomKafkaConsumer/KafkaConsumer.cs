...
namespace Scynet.HatcheryFacade.CustomKafkaConsumer
{
    public class KafkaConsumer
    {
        ...
        public KafkaConsumer(string agentUuid, IConfiguration config, AutoOffsetResetType resetType = AutoOffsetResetType.Earliest)
        {
            ...
            _config.AutoOffsetReset = resetType;
